...
const App = () => {
  ...
  return (
    <div id="main">
      ...
      <input type="text" data-testid="input1" id="inputfirst"></input> <br></br>
      <label>Last Name</label>
      <input type="text" data-testid="input2" id="inputlast"></input>
      <br></br>
      <button data-testid="calculate_relationship" onClick={calRelation}>
